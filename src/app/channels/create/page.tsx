        ...
        <div className="flex flex-col justify-center h-full w-full bg-gradient-to-br from-custom-blue to-custom-blue-light p-6 rounded-2xl">
          <div className="flex-1 flex items-center justify-center">
            <div className="bg-white p-6 rounded-xl shadow-md w-full max-w-2xl h-full flex flex-col justify-center">
              ...
              <form onSubmit={(e) => { if (step === 5) { e.preventDefault(); handleSubmit(e); } }} className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_prof_transducer}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                    ...
                    <>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_temp_linear_factor}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_valor_campo_b}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_valor_campo_d}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_zero_read_digits}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_zero_read_temp}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          id="par_offset_units"
                          value={formData.par_offset_units}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                    ...
                    <>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_linear_gage_factor}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_thermal_factor}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_valor_fabrica_c}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          value={formData.par_valor_campo_c}
                          onChange={handleChange}
                          className="w-full border px-2 py-1 text-sm rounded"
                        />
                      </div>
